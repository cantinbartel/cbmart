        ...
        <>
            ...
            {loading ? <p>Loading...</p> : error ? <p>{error}</p> : (
                <div className="h-full w-1/3 mx-auto my-8">
                    <h1 className="uppercase text-3xl font-semibold mb-6">Create Product</h1>
                    <form className="flex flex-col justify-center items-start" onSubmit={handleSubmit}>
                        ...
                        <button className="uppercase bg-black text-white font-semibold px-3 py-2 rounded">Create</button>
                    </form>
                </div>
            )}
        </>
